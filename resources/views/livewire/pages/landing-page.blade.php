...
">
    ...
    <!-- News Ticker -->
    <div class="royal-blue-bg text-white py-2 overflow-hidden">
        <div class="container mx-auto">
            <div class="flex items-center">
                <span class="bg-white royal-blue-accent px-3 py-1 rounded text-sm font-bold ml-4">عاجل</span>
    ...
    <section class="gradient-bg hero-pattern text-white py-20" id="home">
        <div class="container mx-auto px-4 text-center">
            ...
            <div class="flex flex-col sm:flex-row items-center justify-center space-y-4 sm:space-y-0 sm:space-x-6 sm:space-x-reverse">
                <a href="/register" class="bg-white royal-blue-accent px-8 py-4 rounded-lg font-bold text-lg hover:bg-gray-100 transition-all transform hover:scale-105 shadow-lg">
                    <i class="fas fa-user-plus ml-2"></i>
                    ابدأ الآن - إنشاء حساب
                </a>
                <a href="#services" class="border-2 border-white text-white px-8 py-4 rounded-lg font-bold text-lg hover:bg-white hover:royal-blue-accent transition-all">
        ...
        <div class="container mx-auto px-4">
            <div class="grid grid-cols-2 md:grid-cols-4 gap-8 text-center">
                <div class="card-hover p-6" x-data="{ count: 0, target: 15000 }" x-init="
                    ...
                    <p class="silver-gray-text font-medium">قضية سنوياً</p>
                </div>
                <div class="card-hover p-6" x-data="{ count: 0, target: 850 }" x-init="
                    ...
                    <div x-text="count.toLocaleString('ar-EG')" class="stats-counter"></div>
                    <p class="silver-gray-text font-medium">محامي مسجل</p>
                </div>
                <div class="card-hover p-6" x-data="{ count: 0, target: 45 }" x-init="
                    ...
                    <div x-text="count.toLocaleString('ar-EG')" class="stats-counter"></div>
                    <p class="silver-gray-text font-medium">قاضي</p>
                </div>
                <div class="card-hover p-6" x-data="{ count: 0, target: 98 }" x-init="
                    ...
                    <p class="silver-gray-text font-medium">% رضا المستخدمين</p>
                </div>
            </div>
        </div>
    </section>
    ...
    <!-- Services Section -->
    <section class="py-20 off-white-bg" id="services">
        <div class="container mx-auto px-4">
            <div class="text-center mb-16">
                <h3 class="text-4xl font-bold royal-blue-accent mb-4">خدماتنا الإلكترونية</h3>
                <p class="text-xl silver-gray-text max-w-2xl mx-auto">نوفر مجموعة شاملة من الخدمات القضائية الرقمية لتسهيل إجراءاتكم</p>
            </div>
            
            <div class="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
                @foreach ($services as $service)
                    <div class="bg-white p-8 rounded-xl shadow-lg card-hover" x-data="{ hover: false }" @mouseenter="hover = true"
                        @mouseleave="hover = false">
                        <div class="w-16 h-16 rounded-full flex items-center justify-center mb-6 transition-all duration-300"
                            :class="hover ?
                                'bg-blue-500 scale-110' :
                                'bg-blue-100'">
                            <i class="fas fa-file-upload text-blue-600 text-2xl transition-all duration-300"
                                :class="hover ? 'text-white scale-110' : ''"></i>
                        </div>
                        <h4 class="text-xl font-bold text-gray-800 mb-4">{{ $service->name }}</h4>
                        <p class="text-gray-600 mb-6">{{ $service->description }}</p>
                        <a href="{{ route('services.create', ['id' => $service->id]) }}"
                            class="text-blue-600 font-bold hover:text-blue-800 transition-colors flex items-center">
                             :class="hover ? 
                        ...
                        <p class="silver-gray-text mb-6" x-text="service.desc"></p>
                        <a href="/register" class="royal-blue-accent font-bold hover:text-blue-800 transition-colors flex items-center">
    ...
    <section class="py-20 bg-white">
        <div class="container mx-auto px-4">
            <div class="text-center mb-16">
                <h3 class="text-4xl font-bold royal-blue-accent mb-4">كيف يعمل النظام؟</h3>
                <p class="text-xl silver-gray-text">خطوات بسيطة للاستفادة من خدماتنا الإلكترونية</p>
            </div>
            ...
            <div class="grid md:grid-cols-3 gap-8">
                <template x-for="(step, index) in [
                    ...
                    <div class="text-center" x-data="{ hover: false }"
                         ...
                         @mouseleave="hover = false">
                        <div class="w-20 h-20 royal-blue-bg text-white rounded-full flex items-center justify-center text-2xl font-bold mx-auto mb-6 transition-all duration-300"
                        ...
                        <h4 class="text-xl font-bold text-gray-800 mb-4 transition-colors"
                            :class="hover ? 'royal-blue-accent' : ''" x-text="step.title"></h4>
                        <p class="silver-gray-text transition-colors"
    ...
    <section class="py-20 bg-blue-50" id="about">
        <div class="container mx-auto px-4">
            <div class="grid lg:grid-cols-2 gap-12 items-center">
                <div>
                    <h3 class="text-4xl font-bold royal-blue-accent mb-6">عن محكمة النقض المصرية</h3>
                    <p class="text-lg silver-gray-text mb-6 leading-relaxed">
                    ...
                    <p class="text-lg silver-gray-text mb-8 leading-relaxed">
                    ...
                    <div class="grid grid-cols-2 gap-6">
                        <div class="text-center p-4 bg-white rounded-lg shadow-sm">
                            <div class="text-3xl font-bold royal-blue-accent">1931</div>
                            <div class="silver-gray-text">سنة التأسيس</div>
                        </div>
                        <div class="text-center p-4 bg-white rounded-lg shadow-sm">
                            <div class="text-3xl font-bold royal-blue-accent">6</div>
                            <div class="silver-gray-text">دوائر متخصصة</div>
                        </div>
                    </div>
                </div>
                <div class="text-center">
                    <div class="bg-white rounded-2xl p-8 shadow-xl" x-data="{ hover: false }"
                         @mouseenter="hover = true"
                         @mouseleave="hover = false">
                        <i class="fas fa-building text-8xl royal-blue-accent mb-6 transition-all duration-300"
                           :class="hover ? 'scale-110 text-blue-700' : ''"></i>
                        <h4 class="text-2xl font-bold text-gray-800 mb-4 transition-colors"
                            :class="hover ? 'royal-blue-accent' : ''">رؤيتنا</h4>
                        <p class="silver-gray-text transition-colors"
    ...
    <section class="py-20 bg-white" id="contact">
        <div class="container mx-auto px-4">
            <div class="text-center mb-16">
                <h3 class="text-4xl font-bold royal-blue-accent mb-4">اتصل بنا</h3>
                <p class="text-xl silver-gray-text">نحن هنا لمساعدتك في جميع استفساراتك</p>
            </div>
            ...
            <div class="grid md:grid-cols-3 gap-8">
                <template x-for="(contact, index) in [
                    ...
                    <div class="text-center p-8 off-white-bg rounded-lg" x-data="{ hover: false }"
                         @mouseenter="hover = true"
                         @mouseleave="hover = false">
                        ...
                        <h4 class="text-xl font-bold text-gray-800 mb-4 transition-colors"
                            :class="hover ? `royal-blue-accent` : ''" x-text="contact.title"></h4>
                        <p class="silver-gray-text transition-colors"
